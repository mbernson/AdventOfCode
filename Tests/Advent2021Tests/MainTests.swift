...
final class MainTests: XCTestCase {
  ...
  func test2021Day7() throws {
    ...
    // Warning: inefficient solution
//    XCTAssertEqual(try runAdventCommand(arguments: ["day7", "part2"]), "98905973\n")
  }

  func test2021Day8() throws {
    XCTAssertEqual(try runAdventCommand(arguments: ["day8", "part1"]), "479\n")
    XCTAssertEqual(try runAdventCommand(arguments: ["day8", "part2"]), "0\n")
  }

  func test2021Day9() throws {
    XCTAssertEqual(try runAdventCommand(arguments: ["day9", "part1"]), "548\n")
    XCTAssertEqual(try runAdventCommand(arguments: ["day9", "part2"]), "786048\n")
  }

  func test2021Day10() throws {
    XCTAssertEqual(try runAdventCommand(arguments: ["day10", "part1"]), "413733\n")
    XCTAssertEqual(try runAdventCommand(arguments: ["day10", "part2"]), "3354640192\n")
  }
