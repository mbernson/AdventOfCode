...
final class Day4Tests: XCTestCase {
  func testValidPassportParsing() throws {
    ...
    XCTAssertEqual(
      Day4().parsePassportFields(in: validPassport),
      [
        "byr" : "1937",
        "iyr" : "2017",
        "eyr" : "2020",
    ...
    XCTAssertEqual(
      Day4().parsePassportFields(in: validPassportMissingCid),
      [
        "byr" : "1931",
        "iyr" : "2013",
        "eyr" : "2024",
  ...
  func testInvalidPassportParsing() throws {
    ...
    XCTAssertEqual(
      Day4().parsePassportFields(in: invalidPassport),
      [
        "byr" : "1929",
        "iyr" : "2013",
        "eyr" : "2023",
    ...
    XCTAssertEqual(
      Day4().parsePassportFields(in: invalidPassportMissingByr),
      [
        "iyr" : "2011",
        "eyr" : "2025",
        "hgt" : "59in",
  ...
  func testMultipleInvalidPassports() throws {
    ...
    XCTAssertEqual(Day4().parsePassports(in: input), [])
  }
}
